...
import torch
from lib.modules.segmentation.mimunet import MIMUNet
from lib.modules.layers.res_net import ResNetBackbone
from lib.modules.layers.adn_fn import get_adn_fn

h,w,d,c = 32,32,20,1

backbone_structure = [[16,16,3,1],[32,32,3,1],[64,64,3,1],[128,128,3,1]]
backbone_args = {
    'spatial_dim': 2,
    'in_channels': 1,
