...
def label_smoothing(y:torch.Tensor,
                    smooth_factor:float)->torch.Tensor:
...
def mixup(x:torch.Tensor,y:torch.Tensor,
          mixup_alpha:float,
          g:np.random.Generator=None)->Tuple[torch.Tensor,torch.Tensor]:
...
def partial_mixup(x:torch.Tensor,
                  y:torch.Tensor,
                  mixup_alpha:float,
