...
argument_factory = {
    ...
    "test_checkpoints": dict(
        ...
        default=None,
        nargs="+",
        help='Test using these checkpoints.'),
    # prediction specific 
    "prediction_ids": dict(
        type=str,
        default=None,
    ...
    "mask_mode": dict(
        type=str,default="mask_is_labels",
    ...
    "anchor_csv": dict(
        type=str,
        required=True,
        help="Path to CSV file containing anchors"),
    "min_anchor_area": dict(
        type=float,
        default=None,
        help="Minimum anchor area (filters anchors)"),
    ...
    "iou_threshold": dict(
        type=float,
        default=0.5,
        help="IoU threshold for pred-gt overlaps."),
    ...
    "loss_comb": dict(
        default=0.5,
        type=float,
        help="Relative weight for combined losses"),
    "loss_scale": dict(
        default=1.0,
        type=float,
    ...
    "mask_keys": dict(
        type=str,
        default=None,
        help="Mask keys in dataset JSON"),
    ...
    "dataset_iterations_per_epoch": dict(
        default=1.0,
        type=float,
        help="Number of dataset iterations per epoch"),
    "picai_eval": dict(
        action="store_true",
    ...
    "segmentation_prediction_mode": dict(
        choices=["image","deep_features","bounding_box"],
        default="image"),
    # ssl-specific
    "jpeg_dataset": dict(
        action="store_true",
    ...
    "stop_gradient": dict(
        action="store_true",
        help="Stops gradient for teacher"),
