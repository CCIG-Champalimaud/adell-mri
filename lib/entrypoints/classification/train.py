...
from ...utils.dataset_filters import (
    filter_dictionary,filter_dictionary_with_filters)
...
def main(arguments):
    ...
    parser.add_argument_by_key(
        [("classification_net_type","net_type"),
         ...
         "checkpoint_dir", "checkpoint_name", "checkpoint","delete_checkpoints",
         "freeze_regex", "not_freeze_regex", "exclude_from_state_dict",
         "resume_from_last",
         "monitor",
         "project_name", "summary_dir", "summary_name", "metric_path", "resume",
         "warmup_steps", "start_decay", "warmup_steps", "dropout_param",
         "accumulate_grad_batches", "gradient_clip_val", "early_stopping", "swa",
         "learning_rate", "batch_size",
         "class_weights", "weighted_sampling",
