...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_patterns",dest="input_patterns",nargs="+",type=str,
        help="Patterns for glob yielding files.",required=True)
    parser.add_argument(
        "--pattern_id",dest="pattern_id",type=str,
        default='[A-Za-z0-9]+_[A-Za-z0-9]+',
        help="Regex pattern for the patient id.")
    parser.add_argument(
        "--pattern_sequence",dest="pattern_sequence",type=str,
        default='[A-Za-z0-9]+_[A-Za-z0-9]+',
        help="Regex pattern for the sequence.")
    parser.add_argument(
        "--mask_pattern",dest="mask_pattern",type=str,
