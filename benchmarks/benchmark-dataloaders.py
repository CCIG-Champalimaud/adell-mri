...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="base_path",
        type=str,
        help="Path to ProstateX dataset",
        required=True,
    )
    parser.add_argument(
        "--mod",
    ...
    parser.add_argument(
        "--downsample_rate",
        dest="downsample_rate",
        type=float,
        help="Resizes images with downsample rate",
    )
    parser.add_argument("--batch_size", dest="batch_size", type=int)
    parser.add_argument("--spatial_dim", dest="spatial_dim", type=int)
    ...
    keys = [args.mod]
    label_keys = [
        "{}_{}_segmentations".format(args.mod, c) for c in args.classes
    ]
    ...
    if args.spatial_dim == 2:
        ...
        transforms_val.append(SlicesToFirst([args.mod, label_key]))
