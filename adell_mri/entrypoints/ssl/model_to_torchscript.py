...
def main(arguments):
    ...
    parser.add_argument("--ssl_method", dest="ssl_method", default="simclr")
    parser.add_argument(
        "--forward_method_name", dest="forward_method_name", default="forward"
    )
    parser.add_argument(
        "--ema",
        dest="ema",
    ...
    network_config_correct = {
        k: network_config_correct[k]
        for k in network_config_correct
        if k not in ["prediction_head_args", "projection_head_args"]
    }
