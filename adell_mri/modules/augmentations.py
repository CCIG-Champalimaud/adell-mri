...
AUG_DICT = {
    ...
    "lowres": monai.transforms.RandSimulateLowResolution,
    "distort": monai.transforms.RandGridDistortion,
...
AUG_DICT_DICT = {
    ...
    "lowres": monai.transforms.RandSimulateLowResolutiond,
    "distort": monai.transforms.RandGridDistortiond,
...
AUG_PARAM_DICT = {
    ...
    "rbf": {"coeff_range": 0.3},
    "contrast": {"gamma": 3},
    "gaussian_smooth_x": {"sigma_x": 0.3, "sigma_y": 0.0, "sigma_z": 0.0},
    "gaussian_smooth_y": {"sigma_x": 0.0, "sigma_y": 0.3, "sigma_z": 0.0},
    "gaussian_smooth_z": {"sigma_x": 0.0, "sigma_y": 0.3, "sigma_z": 0.3},
    "gaussian_sharpen_x": {"sigma1_x": 0.3, "sigma1_y": 0.0, "sigma1_z": 0.0},
    "gaussian_sharpen_y": {"sigma1_x": 0.0, "sigma1_y": 0.3, "sigma1_z": 0.0},
    "gaussian_sharpen_z": {"sigma1_x": 0.0, "sigma1_y": 0.0, "sigma1_z": 0.3},
    "gibbs_noise": {"alpha": 1.0},
    "spike_noise": {"intensity_range": 0.5},
    "rician_noise": {"std": 0.2},
    "lowres": {"zoom_range": 0.2},
    "distort": {"distort_limit": 0.02},
...
AUG_PARAM_CORRECTION = {
    ...
    "lowres": lambda x: (1 - x, 1.0),
    "distort": lambda x: (-x, x),
