# from: https://github.com/DIAGNijmegen/Report-Guided-Annotation
...
def extract_lesion_candidates_dynamic(
    ...
    while len(confidences) < num_lesions_to_extract:
        ...
        extracted_lesions_grown = ndimage.morphology.binary_dilation(
...
def extract_lesion_candidates(
    ...
    if threshold == "dynamic":
        (
            ...
            confidences,
            indexed_pred,
        ) = extract_lesion_candidates_dynamic(
            softmax=softmax,
        ...
        (
            ...
            confidences,
            indexed_pred,
        ) = extract_lesion_candidates_static(
            softmax=softmax,
            threshold=threshold,
            min_voxels_detection=min_voxels_detection,
            max_prob_round_decimals=max_prob_round_decimals,
